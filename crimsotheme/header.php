            ...
            <div class="crimso-responsive-nav">
                <div class="container">
                    <div class="crimso-responsive-menu">
                        <div class="logo">
                            <a href="index.html">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/logo.png" class="black-logo" alt="image">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/logo-2.png" class="white-logo" alt="image">
                            </a>
                        </div>
                    </div>
                </div>
